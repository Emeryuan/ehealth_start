						...
						<div class="container">
					     ...
					     <div class="top-menu">
							<span class="menu"> </span>
								...
								<li><a class="active" href="doctorIndex.html" data-hover="主页">主页</a></li>
				...
				<div class="banner-bottom">
			      <div class="container">
			         <div class="banner-bot-grids" style="text-align: center;">
				        ...
				        <a href="doctorHelper.html" style="text-decoration: none;color: white">
...
String phone=request.getParameter("user"); //从表单获得 
String password=request.getParameter("pwd"); //从表单获得 
...
String insert_sql = "insert into user(phone,password) values(" + phone + "','" +  password + "')"; 
